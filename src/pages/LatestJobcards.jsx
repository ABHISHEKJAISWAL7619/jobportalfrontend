...
//     // let jobstore  = useSelector((state)=>state.AllJob)
// //   console.log(jobstore.allJobs)
// //  var job = jobstore.allJobs.jobs;
// let jobstore  = useSelector((state)=>state.AllJob)
//   console.log(jobstore.allJobs.jobs)
// //  console.log(job);
//   return (
//   <>
//    {jobstore.allJobs.jobs.map((items)=>{
//     return <div className='p-5 rounded-md shadow-xl bg-white border border-gray-400 cursor-pointer'>
//         <div>
//             <h1 className="font-medium text-lg ">{items.company.name}</h1>
//             <p className="text-sm text-gray-500">{items.location}</p>
//         </div>
//         <div>
//             <h1 className="font-bold text-lg my-2">{items.title}
//             </h1>
//             <p className="text-sm text-gray-600">{items.description}</p>
//         </div>
//         <div className="flex items-center gap-2 mt-4">
//             <Badge className={'text-blue-700 fonty-bold  border-none '} variant = "ghost" >{items.position}</Badge>
//             <Badge className={'text-[#F83002] fonty-bold border-none'} variant = "ghost" >{items.jobtype}</Badge>
//             <Badge className={'text-[#7209b7] fonty-bold border-none'} variant = "ghost" >{items.salary}</Badge>
//         </div>
